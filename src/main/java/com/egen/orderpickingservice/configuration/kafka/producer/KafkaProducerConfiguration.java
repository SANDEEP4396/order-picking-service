package com.egen.orderpickingservice.configuration.kafka.producer;
...
public class KafkaProducerConfiguration {
     ...
     * */
    @Bean
    public ProducerFactory<String, List<OrdersDto>> producerFactoryJson() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, List<OrdersDto>> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, List<OrdersDto>> kafkaTemplateJson() throws UnknownHostException {
